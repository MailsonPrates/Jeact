...
syncDOM.KEY = 'data-key'
syncDOM.IGNORE = 'data-ignore'
syncDOM.CHECKSUM = 'data-checksum'
var parseHTML = function(){};
var KEY_PREFIX = '_sync-dom-'
...
function getKey (node) {
  ...
  var key = node.getAttribute(syncDOM.KEY) || node.id
...
function getCheckSum (node) {
  return node.getAttribute(syncDOM.CHECKSUM) || NaN
}
...
function isIgnored (node) {
  return node.getAttribute(syncDOM.IGNORE) != null
}
